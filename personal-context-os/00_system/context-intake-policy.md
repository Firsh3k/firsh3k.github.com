...
4. **Route** — recommend Global, Project, Shared Knowledge, Lessons, Research/Evals, or Archive.
...
Usually enter as `OBSERVE` or `ACTIVE_CANDIDATE`; compare against existing decisions and personal experience before promotion.
